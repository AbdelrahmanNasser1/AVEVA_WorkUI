...
CmbjsTreeNode.prototype.addToDOM = function (objDOMParent) {
   ...
   if(!maxImageIncluded)
    ...
    {
      d.write("<td nowrap=\"nowrap\" class=\"contenttext\"><img hspace=\"1\" src=\"" + this.icon + "\" border=\"0\" align=\"absmiddle\" /> <a href=\"#\" onclick=\"javascript:LoadTreeview('"+this.DataType+"','"+this.text+"','"+this.xpath+"')\" class=\"AnchorText\" title='"+tooltip+"'>"+this.text+"</a></td>");
    }
    else
    {
        if(!maxImageIncluded)
 ...
 d.write("<td nowrap=\"nowrap\" colspan=2 class=\"contenttext\"><img hspace=\"1\" src=\"" + this.icon + "\" border=\"0\" align=\"absmiddle\" />  <a href=\"#\" onclick=\"javascript:LoadTreeview('"+this.DataType+"','"+this.text+"','"+this.xpath+"')\" class=\"AnchorText\" title='"+tooltip+"'>"+this.text+"</a></td>");
...
{    
    ...
    if(divTreeObj!=null)
    {
        if((maximize)&&(mode))
        {
	        ...
	        divTreeObj.style.height =  (parseInt(winHeight)-divtop) - 60;
