<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Workflow.NET.CodeBehind.Bam.Analyze_ActivityTime" %>
...
<head id="Head1" runat="server">
    <title>Activity Time Detailss</title>
    <style type="text/css">
        html, body
        {
            height:98%;
    ...
    <form id="form1" runat="server" style="height:100%" >
        ...
        <div style="height:99%">
                    <ISWebGrid:WebGrid ID="WebGrid1" runat="server" Height="100%" Width="100%" HorizontalAlign="NotSet"
                        ...
                        <roottable gridlinestyle="NotSet" headerclickaction="SortSingle" allowgrouping="Yes" ColumnFooters="Yes"  > 
                        </roottable>
                    </ISWebGrid:WebGrid>
                </div>
