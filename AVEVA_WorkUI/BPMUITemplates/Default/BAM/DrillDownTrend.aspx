<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Workflow.NET.CodeBehind.Bam.DrillDownTrend" %>
...
<body>
    ...
    <form id="form1" runat="server"  style="height:100%;">
        ...
        <table style="width:100%;height:5%;">   
            <tr>
                <td style="height:5%;width:60%" class="subtitle">                    
                    <span id="spTrendTooltip" runat="server" class="description"> <%=DisplayString%></span>   
        ...
        <div style="width:100%;height:95%;vertical-align:top;">
                    <ISWebGrid:WebGrid ID="WebGrid1" runat="server" Height="100%" Width="100%" HorizontalAlign="NotSet"
                        ...
                        OnPrepareDataBinding="WebGrid1_PrepareDataBinding" OnExport="WebGrid1_Export"
                        ...
                        <LayoutSettings AlternatingColors="true" CellPaddingDefault="2" GridLineColor="#afafaf"
                            ...
                            AllowEdit="Yes" PagingMode="VirtualLoad" VirtualLoadMode="LargeData" VirtualPageSize="50" AutoFitColumns="false" RowHeaders="No">
    ...
    <script>
        document.getElementById("spTrendTooltip").title = "<%=lblDescription1.Text%>";
     </script>
</body>
</html>
