<%@ Page Language="C#" AutoEventWireup="true" Inherits="Workflow.NET.CodeBehind.Bam.SkeltaTemplates_Default_BAM_Analyze_WorkItemTransaction" Theme="" StylesheetTheme="" %>
...
<head id="Head1" runat="server">
    <title>WorkItem TransactionType </title>  
    <style type="text/css">
        html, body
        {
            height:98%;
    ...
    <form id="form1" runat="server" style="height:100%" >
      ...
      <div style="width:100%;height:98%;">
                    <ISWebGrid:WebGrid ID="WebGrid1" runat="server" Height="100%" HorizontalAlign="NotSet"
                        AllowAutoDataCaching="false" Width="100%" OnPrepareExportExecute="WebGrid1_PrepareExportExecute"
                        ...
                        <LayoutSettings AlternatingColors="True" CellPaddingDefault="2" GridLineColor="#afafaf"
                            AlwaysShowHelpButton="False" AllowFilter="Yes" GridLineStyle="Solid" RowHeightDefault="23px"
                            AllowGrouping="Yes" AllowColumnSizing="Yes" Hierarchical="True" GridLines="None"
                            AllowColumnMove="Yes" AllowExport="Yes" AllowSelectColumns="Yes" allowsorting="Yes"
                            FilterBarVisible="False" PagingMode="VirtualLoad" VirtualLoadMode="LargeData" AutoFitColumns="true"
                            VirtualPageSize="50" RowHeaders="No">
                            <HeaderStyle CssClass="GridHeaderStyle" CustomRules="border-bottom: #73A1E4 1px solid"></HeaderStyle>
