<%@ Page Language="C#" AutoEventWireup="true" Inherits="Workflow.NET.CodeBehind.Bam.SkeltaTemplates_Default_BAM_Analyze_WorkItem" Theme="" StylesheetTheme="" %>
...
<head id="Head1" runat="server">
    <title>Workitem Details Page</title>
    <style type="text/css">
        html, body
        {
            height:98%;
        ...
        <table style="width:100%;border-collapse: separate; border-spacing: 2px;height:5%;">
            <tr>
                <td style="height:5%;width:92%" class="subtitle">
                 <span class="subtitle"><%:DisplayString%>
                 </span> 
        ...
        <div style="width:100%;height:98%;">
                    <ISWebGrid:WebGrid ID="WebGrid1" runat="server" Height="100%" HorizontalAlign="NotSet"
                        ...
                        <LayoutSettings AlternatingColors="True" CellPaddingDefault="2" GridLineColor="#afafaf"
                            ...
                            <RowStyle  CustomRules="text-overflow: ellipsis;" CssClass="GridRowStyle"
