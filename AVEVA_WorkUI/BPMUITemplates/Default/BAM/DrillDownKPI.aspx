<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" Inherits="Workflow.NET.CodeBehind.Bam.DrillDownKPI" %>
...
<body>
    ...
    <form id="form1" runat="server" style="height:100%;">
        ...
        <table style="width:100%;">
            <tr>
                <td style="height:5%;width:60%;padding:2px;" class="subtitle">
                    <span id="spKPITooltip" runat="server" class="description"> <%=DisplayString%></span>  
                    <asp:TextBox runat="server" ID="txtGridSize" Style="display:none;" AutoPostBack="true" OnTextChanged="SetSize"></asp:TextBox>                  
                </td>
                 <td style="height:5%;width:35%;text-align:right;padding:2px;" >
                ...
                <td style="height:5%;text-align:right;padding:2px;">                   
        ...
        <table style="width:100%;height:5%" class="lefttdbg" >
            <tr>
                <td style="text-align:left" class="lefttdbg">
                    <table style="width:100%">
            ...
            <div style="width:100%;height:92%;vertical-align:top;">
                    <ISWebGrid:WebGrid ID="WebGrid1" runat="server" Height="100%" Width="100%" HorizontalAlign="NotSet"
                        ...
                        OnExport="WebGrid1_Export" OnPrepareDataBinding="WebGrid1_PrepareDataBinding"
                        ...
                        <LayoutSettings AlternatingColors="true" CellPaddingDefault="2" GridLineColor="#afafaf"
                            ...
                            AllowEdit="Yes" PagingMode="VirtualLoad" VirtualLoadMode="LargeData" VirtualPageSize="50" RowHeaders="No">
    ...
    <script>
        document.getElementById("spKPITooltip").title = "<%=lblDescription1.Text%>";
    </script>
</body>
</html>
