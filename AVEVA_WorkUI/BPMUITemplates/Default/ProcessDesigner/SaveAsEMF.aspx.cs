...
public partial class SkeltaTemplates_Default_ProcessDesigner_SaveAsEMF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition","attachment;filename=" + ProcessDesignerControl.ApplicationName + "_" + ProcessDesignerControl.WorkflowName + "_" + ProcessDesignerControl.FileName + ".emf");
        Response.BinaryWrite(ProcessDesignerControl.GetProcessImageBytes(zoom, true));
        Response.End();
    }
