<%@ Page Language="C#" AutoEventWireup="true" Inherits="Skelta.HWS.UserControls.AuditTrail" %>
<%@ Register Assembly="ISNet.WebUI.WebGrid" Namespace="ISNet.WebUI.WebGrid" TagPrefix="ISWebGrid" %>

<!DOCTYPE HTML>
<html>
<head id="Head1" runat="server">
    <title><%=ResourceManager.GlobalResourceSet.GetString("Audit_History") %></title>
...
<body style="margin:0;overflow:hidden">
    <form id="form1" runat="server" style="height:100%;">
     ...
     <script type="text/javascript" src="<%:TemplateRootPath %>Repository/ListControl/Scripts/menu.js"></script>
     <link rel="stylesheet" type="text/css" href="<%:ThemePath %>Common/StyleSheet/Global.css" />        
            ...
            <div style="height:100%;width:98%;padding-left:8px;">
                    ...
                    <layoutsettings allowexport="yes" alternatingcolors="True" pagingmode="VirtualLoad"
                        virtualloadmode="Default" filterbarvisible="false" allowfilter="Yes" gridlinestyle="Solid"
                        gridlinecolor="#afafaf" cellpaddingdefault="1" rowheightdefault="22px" gridlines="None"
                        virtualpagesize="20" AutoFitColumns="false" AutoHeight="false"  allowsorting="yes"
                        ...
                        <ClientSideEvents  OnRowContextMenu="HideContextMenu"  OnInitialize="OnInitialize"></ClientSideEvents>
                        ...
                        <RowStyle Overflow="Hidden" OverflowX="Hidden" OverflowY="Hidden" CssClass="GridRowStyle" CustomRules="text-overflow: ellipsis; overflow-x: hidden" />
