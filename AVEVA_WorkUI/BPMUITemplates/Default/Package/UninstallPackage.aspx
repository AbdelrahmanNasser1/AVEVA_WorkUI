...
<HEAD id="HEAD1" runat="server">
    ...
    {
        var pageTitle = '<%=resourceManager.GetString("Package Configurations") %>',
                    self = window;
        var oWindow = GetRadWindow();
        switch (messageType)
        {
		...
		<form id="Form1" method="post" runat="server">	
			...
			<table visible="false" id=indicator border="0" cellpadding="0" cellspacing="0" width="0" height="20" align="center" >
				<tr>
					<td  align="center" width="100%" class="description"><B><%=resourceManager.GetString("PKG_IntermediatePageMessageUninstall")%></B></td>
				</tr>
			</table>	
