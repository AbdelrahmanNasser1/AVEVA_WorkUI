...
function editor_generate(objname,userConfig) {
  ...
  editor += '<br><div id="_editor_footer" width="' + config.width + '" align="right" style="background:lightgrey"><button value="Cancel">Cancel</button> <button value="Update">Update</button></span>';
