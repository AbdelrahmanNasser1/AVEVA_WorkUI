<%@ Page Language="C#" AutoEventWireup="true" Inherits="Workflow.NET.CodeBehind.WorkItemList.DelegateWorkItem" Theme="" StylesheetTheme="" %>
...
<body style="overflow:hidden; ">
	...
	<tr style="vertical-align:top;" class="ListHeaderCss">
		<td style="vertical-align:bottom;height:25px;">
			<table style="width:100%;border-collapse:collapse;border-spacing:0px;">
				<tr>
					<td class="fontheading" style="height:25px;"><img src="<%:commonCssPath%>Workitemlist/images/Reassign-workitems.png" align="absmiddle" /><%=_StrDeletgate%></td>
	...
	<tr style="vertical-align:top;">
		<td style="vertical-align:bottom;height:25px;">
			<table style="width:100%;border-spacing:0px;border-collapse:collapse;">
				<tr>
					<td class="description" style="height:25px;">&nbsp;&nbsp;&nbsp;&nbsp;<%=_StrDelegateDesc%></td>
    ...
    <table id="TMain" style="width:94%;margin:0px auto;border-spacing:1px;border-collapse:separate;"   class="tablebg">
        <tr>
...
<tr>
	<td style="vertical-align:bottom;padding-bottom:10px;">
		<table style="margin:0px auto;border-spacing:1px;border-collapse:collapse;width:100%;" >
			<tr>
                <td class="lefttdbg" style="text-align:right;padding-right:10px;" width="100%"> 
                 ...
                 <td class="lefttdbg" style="text-align:right;padding-right:10px;" width="100%"> 
		            <asp:Button runat="server" ID="btnDelegate" CssClass="inputbutton" OnClick="btnDelegate_Click"  Text="Delegate"  />
		        </td>
        ...
        <telerik:RadWindowManager ID="Singleton" Modal="true" Skin="AWTWindow" EnableEmbeddedSkins="false" EnableEmbeddedBaseStylesheet="false"
