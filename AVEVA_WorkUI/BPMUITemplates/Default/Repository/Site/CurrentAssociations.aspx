<%@ Page Language="C#" AutoEventWireup="true" Inherits="Skelta.Repository.Web.CodeBehind.CurrentAssociations" %>
...
<script  type ="text/javascript">
    ...
    function NaviagateBack(message, fromArchestrA) {
        se.ui.messageDialog.showAlert("<%=_GRS.GlobalResourceSet.GetString("ecm_list_cm_view_associations") %>", message, function () {
            if (fromArchestrA == "True" || fromArchestrA == true) {
                window.parent.location.href = 'WorkflowList.aspx?FromArchestrA=true';
            }
            else {
