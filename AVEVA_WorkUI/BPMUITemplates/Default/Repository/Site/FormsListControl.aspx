<%@ Page Language="C#" Inherits="Skelta.Forms.Codebehind.FormsControl" MasterPageFile="~/BPMUITemplates/Default/Repository/Site/Html5MasterPage.master" AutoEventWireup="true" Title="Untitled Page"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MenuTitle" runat="server"> 
    <div>		        
        <%=lcl.GlobalResourceSet.GetString("ec_menu_forms") %>						
    </div>
</asp:Content>
