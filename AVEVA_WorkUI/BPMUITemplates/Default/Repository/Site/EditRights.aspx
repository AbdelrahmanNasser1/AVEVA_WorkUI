<%@ Page Language="C#" AutoEventWireup="true" Inherits="Skelta.Repository.Web.CodeBehind.EditRights" %>
<link href="<%=Microsoft.Security.Application.Encoder.HtmlEncode(cssPath)%>/Global.css" rel="stylesheet" type="text/css" />

<html>
<head>
    <title><%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %></title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function closeWindow(message) {
            ...
            se.ui.messageDialog.showAlert('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', message, function () { oWindow.close(); });
        }
        
        function showErrorMessage(message)
        {
            resizefunction(); 
            se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', message);
        }
    </script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validate()
        {
            ...
            {
                se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', '<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_validate_rightname") %>');
                document.getElementById('hdnvalidate').value = "true";
                return;
            }
            if (document.getElementById('txtRightsCode').value == "")
            {
                se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', '<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_validate_rightcode") %>');
                document.getElementById('hdnvalidate').value = "true";
            ...
            {
                se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', '<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_validate_scope") %>');
                document.getElementById('hdnvalidate').value = "true";
                return;
            }
            if (document.getElementById('cboType').value == defaultValue || document.getElementById('cboType').value == 0)
            {
                se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', '<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_validate_type") %>');
                document.getElementById('hdnvalidate').value = "true";
                return;
            }
            ...
            if (rdbtn[0].checked)
            {
                ...
                {
                    se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', '<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_validate_followertype") %>');
                    document.getElementById('hdnvalidate').value = "true";
                    return;
                }
            }
            if (document.getElementById('cboRightsLevel').value.indexOf('ListSpecific') != -1)// == 'List Specific' || document.getElementById('cboRightsLevel').value == 4)
            {
                ...
                var tableBody = document.getElementById('chkRights').childNodes[0]; 
                ...
                {
                    se.ui.messageDialog.showError('<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_title") %>', '<%=_ResManager.GlobalResourceSet.GetString("ec_rights_edit_validate_lists") %>');
                    document.getElementById('hdnvalidate').value = "true";
                    return;
                }
            }
                ...
                <table width="98%" border="0" cellspacing="1" cellpadding="5" align="center">
                    <tr>
                        <td colspan="2" class="pagetitle">
                            <img src="<%=Microsoft.Security.Application.Encoder.HtmlEncode(ThemeURL)%>Repository/Site/images/new-security-popup.png" align="absmiddle" />&nbsp;&nbsp;
                            <%= _ResManager.GlobalResourceSet.GetString("ec_rights_edit_title2")%>
                        </td>
                    </tr>
                    <tr>
                        <td class="description">
                        &nbsp;&nbsp;
                            <%= _ResManager.GlobalResourceSet.GetString("ec_rights_edit_title2_desc")%>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="divbody">
                <table id="TMain" width="94%" align="center" border="0" cellpadding="7" cellspacing="1"
                    ...
                    <tr style="height: 30px">
                        ...
                        <td class="righttdbg" style="width: 55%">
                            <asp:TextBox ID="txtRightsName" CssClass="inputtext" runat="server" Width="300px" />
                        </td>
                    </tr>
                    <tr style="height: 30px">
                        <td class="lefttdbg" valign="top" style="width: 45%">
                        ...
                        <td class="righttdbg" style="width: 55%">
                            <asp:TextBox ID="txtRightsCode" CssClass="inputtext" runat="server" Width="300px" />
                        </td>
                    </tr>
                    <tr style="height: 30px">
                        <td class="lefttdbg" valign="top" style="width: 45%">
                        ...
                        <td class="righttdbg" style="width: 55%">
                            <asp:DropDownList ID="cboRightsLevel" runat="server" CssClass="inputselect" OnSelectedIndexChanged="cboRightsLevel_SelectedIndexChanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr id="ValueType" style="height: 30px">
                        ...
                        <td class="righttdbg" style="width: 55%">
                            <asp:DropDownList ID="cboType" CssClass="inputselect" runat="server">
                                <asp:ListItem Selected="true" Text="Select">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr id="IsApplicableToChild">
                        <td class="lefttdbg" valign="top" style="width:45%">
                            <span class="subtitle">
                    ...
                    <tr id='ChildValueType' style="height: 30px" runat="server">
                        <td class="lefttdbg" valign="top" style="width: 45%">
                            <span class="subtitle">
                    ...
                    <tr id="Rights" style="height: 100%">
                        <td id="listrights" class="lefttdbg" valign="top" style="width: 45%">
                            <span class="subtitle">
                        ...
                        <td class="righttdbg" style="width: 55%">
                            <div id="divLists" style="overflow: auto; height: 100%">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td class="righttdbg">
                                            <asp:CheckBoxList ID="chkRights" runat="server" CssClass="inputcheckbox">
                                            </asp:CheckBoxList>
                                        </td>
                                    </tr>
                                </table>
                ...
                <table border="0" cellpadding="13" cellspacing="0" width="100%">
                    <tr>
                        <td id="tdNote" style="display: none">
                            <span class="note">
                                <img src="<%=Microsoft.Security.Application.Encoder.HtmlEncode(ThemeURL)%>Repository/Site/images/icon-warnings.png" align="absmiddle" />&nbsp;&nbsp;
