<%@ Page Language="C#" AutoEventWireup="true" Inherits="Skelta.SSRS.Connector.CodeBehind.SSRSReportDelete" %>
...
<html>
<head runat="server">
    <title><%=_GlobalResource.GetString("ec_ssrs_report_delete_title")%></title>
