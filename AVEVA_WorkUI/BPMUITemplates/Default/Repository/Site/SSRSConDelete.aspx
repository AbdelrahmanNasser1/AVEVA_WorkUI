<%@ Page Language="C#" AutoEventWireup="true" Inherits="Skelta.SSRS.Connector.CodeBehind.SSRSConDelete" %>
...
<html>
<head runat="server">
    <title><%=_GlobalResource.GetString("ec_ssrs_delete_title")%></title>
