<%@ Control Language="C#" AutoEventWireup="true" Inherits="Skelta.Repository.CodeBehind.WebAPI.WebApiSourceRibbonBar" %>
        ...
        [
            ...
            <%if(Platform == Skelta.FarmManager.Platform.OnPremise) { %> 
            {
                "Synch":
                {
                    ...
                    "Text": "<%=GetLangSpecText("ec_rbn_webapisource_sync") %>",
                    "Tooltip": "<%=GetLangSpecText("ec_rbn_webapisource_sync") %>",
                    "Image": "<%=ThemeUrl%>Repository/ListControl/images/ActionBarIcons/Sync.png",
                    "HoverImage": "<%=ThemeUrl%>Repository/ListControl/images/ActionBarIcons/HoverIcons/Sync.png",
                    "Action": "javascript:ExecuteSettingsActionFlag('_sys_synch')",
                    "OpenMode": "Popup",
                    "SubItems": []
                }
            },
...
<div style="width: 100%; height: 100%;white-space:nowrap;display:none;" class="divMain">
    <div class="divMenu" style="width: 80px;">
                ...
                <tr>
                    <td style="height: 25px; text-align: center; padding: 2px">
                        <a href="javascript:ExecuteSettingsActionFlag('_sys_new')" class="sectionitem">
                            <img alt=" <%=GetLangSpecText("WebApiSource_New_alttext")%>" src="<%=ThemeUrl%>Repository/ListControl/images/icons-ribbon/SAP-newConnection.png"
        ...
        <div class="sectiontitle divdowntext">
            <%=GetLangSpecText("WebApiSource_New")%>
        </div>
    </div>
