<%@ Control Language="C#" AutoEventWireup="true" Inherits="SE.Bpm.RabbitMQ.CodeBehind.RabbitMQConnectionListGrid" %>
                    ...
                    "SubItems": [
                        {
                            ...
                            "Text": "<%=GetLangSpecText("ecm_rbn_rmqtemp_new") %>",
                            "Tooltip": "<%=GetLangSpecText("ecm_rbn_rmqtemp_new_alt") %>",
            ...
            var RightPackageTemplateJsonObj =
...

                    {
                        "Edit":
                        {
                            ...
                            "Text": "<%=GetLangSpecText("ecm_rbn_rmq_edit")%>",
                            "Tooltip": "<%=GetLangSpecText("ecm_rbn_rmq_edit_alt") %>",
                    ...
                    },
                    {
                        "View":
                        {
                            ...
                            "Text": "<%=GetLangSpecText("ecm_rbn_rmq_view")%>",
                            "Tooltip": "<%=GetLangSpecText("ecm_rbn_rmq_view_alt") %>",
                            ...
                            "Action": "javascript:ExecuteActionForSelectedRow('_sys_view_rmq')",
                            "OpenMode": "Popup",
                            "SubItems": []
                        }
                    },

                    {
                        "Delete":
                        {
                            ...
                            "Text": "<%=GetLangSpecText("ecm_rbn_rmq_delete")%>",
                            "Tooltip": "<%=GetLangSpecText("ecm_rbn_rmq_delete_alt")%>",
                ...
                <tr>
                    <td style="height:25px;text-align:left">
                        <span><a href="javascript:ExecuteAction('_sys_new')" class="sectionitem">
                            <img alt="<%=GetLangSpecText("ecm_rbn_rmq_new_alt") %>" src="<%=ThemeUrl%>Repository/ListControl/images/icons-ribbon/icon-package-new.png"
                                width="26" height="26" style="vertical-align:middle;border-width:0" /><%=GetLangSpecText("ecm_rbn_rmq_new") %></a></span>
                    </td>
                </tr>
                <tr>
                    <td style="height:25px;text-align:left">
                ...
                <tr>
                    <td style="height:25px;text-align:left">
                        <span><a href="javascript:ExecuteActionForSelectedRow('_sys_edit')"
                            class="sectionitem">
                            <img alt="<%=GetLangSpecText("ecm_rbn_rmq_edit_alt") %>"  src="<%=ThemeUrl%>/Repository/ListControl/images/icons-ribbon/icon-edit.png"
                              style="vertical-align:middle;border-width:0" /><%=GetLangSpecText("ecm_rbn_rmq_edit")%></a></span>
                    </td>
                    <td style="height:25px;text-align:left">
                        <span><a href="javascript:ExecuteActionForSelectedRow('_sys_view_rmq')"
                            class="sectionitem">
                            <img alt="<%=GetLangSpecText("ecm_rbn_rmq_view_alt") %>"  src="<%=ThemeUrl%>/Repository/ListControl/images/icons-ribbon/icon-view-item.png"
                               style="vertical-align:middle;border-width:0" /><%=GetLangSpecText("ecm_rbn_rmq_view")%></a></span>
                    </td>
                    <td style="height:25px;text-align:left">
                        <span><a href="javascript:ExecuteActionForSelectedRow('_sys_delete')" class="sectionitem">
                            <img alt="<%=GetLangSpecText("ecm_rbn_rmq_delete_alt")%>"  src="<%=ThemeUrl%>/Repository/ListControl/images/icons-ribbon/delete.png"
                                style="vertical-align:middle;border-width:0" /><%=GetLangSpecText("ecm_rbn_rmq_delete")%></a></span>
                    </td>
                </tr>
            </table>
        </div>
