...
function LoadRightActionBar() {
    ...
    ActionBar.showRightMenu(RightSSRSConnJsonObj);
}
...
var SSRSConnjsonObj =
                ...
                "New":
                    {
                        ...
                        "Text": "<%=GetLangSpecText("ec_ssrs_New")%>",
                        "Tooltip": "<%=GetLangSpecText("ec_ssrs_New_alttext")%>",
    ...
    var RightSSRSConnJsonObj =
            [
                {
                    "Edit":
                    {
                        "Id": "5987319E-C0E4-4142-9C01-53389025A3BF",
                        "Text": "<%=GetLangSpecText("ec_ssrs_con_Edit")%>",
                        "Tooltip": "<%=GetLangSpecText("ec_ssrs_Edit_Alttext")%>",
...

                {
                    "Delete":
                    {
                        ...
                        "Text": "<%=GetLangSpecText("ec_ssrs_con_Delete")%>",
                        "Tooltip": "<%=GetLangSpecText("ec_ssrs_Delete_Alttext")%>",
    ...
    {
        ActionBar.init(SSRSConnjsonObj, "actionBarDiv");
    }
        ...
        <div class="divTopImage" style="width:100%">   
            <table style="width: 100%; height: 65px; border-width: 0; border-spacing: 0; border-collapse: collapse; border: 0px solid;">
             ...
             <a href="javascript:ExecuteAction('_sys_new')" class="sectionitem">
                <img alt="<%=GetLangSpecText("ec_ssrs_New_alttext")%>"  src="<%=templateThemeDirectory %>Repository/ListControl/images/icons-ribbon/SSRS-newConnection.png" style="width:36px;height:36px;border-width:0px;" />
             </a>
                        </td>
                </tr>
            </table>
...
<div class="divMenu" style="width: 110px;">
                ...
                <tr>
                    <td style="height:20px;text-align:left;">                      
                        ...
                        <span><a href="javascript:ExecuteActionForSelectedRow('_sys_edit')" class="sectionitem">
                                                    <img alt=" <%=GetLangSpecText("ec_ssrs_Edit_Alttext")%>" src="<%=templateThemeDirectory %>Repository/ListControl/images/icons-ribbon/icon-edit.png"
                                                     style="vertical-align: middle;width:23px;height:23px;border-width:0px;"  />
                                                    <%=GetLangSpecText("ec_ssrs_con_Edit")%>
                                                </a></span>
                    </td>
                </tr>
                <tr>
                    <td style="height:20px;text-align:left;">
                         <span><a href="javascript:ExecuteActionForSelectedRow('_sys_delete')" class="sectionitem">
                                    <img alt="<%=GetLangSpecText("ec_ssrs_Delete_Alttext")%>" src="<%=templateThemeDirectory %>Repository/ListControl/images/icons-ribbon/delete.png"
                                        style="vertical-align: middle;width:23px;height:23px;border-width:0px;" />
                                    <%=GetLangSpecText("ec_ssrs_con_Delete")%>
                        </a></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="sectiontitle divdowntext">
	     <%=GetLangSpecText("ec_ssrs_con_Actions")%>
        </div>
    </div>
