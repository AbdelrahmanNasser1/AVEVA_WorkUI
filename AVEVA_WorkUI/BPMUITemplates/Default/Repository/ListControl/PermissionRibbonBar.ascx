<%@ Control Language="C#" AutoEventWireup="true" Inherits="Skelta.Repository.Web.CodeBehind.PermissionRibbonBar" %>
<style type="text/css">
			<!--
			a {
                                            ...
                                            <td height="25" align="left">
                                                <div id="category">
                                                    <img src="images/icons-ribbon/icon-category.png" width="16" height="16" hspace="2"
                                                        align="absmiddle" /><a href="javascript:ExecuteAction('_sys_newcategory')" class="runtext3">Category</a>
</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="25" align="left" class="runtext3">
                                                <img src="images/icons-ribbon/icon-workflow.png" width="16" height="16" hspace="2"
                                                    align="absmiddle" /><a href="javascript:ExecuteAction('_sys_newworkflow')" class="runtext3">Workflow</a></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="4" align="right" valign="bottom" background="images/borders-ribbon/right.png">
