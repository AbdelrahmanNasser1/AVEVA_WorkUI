<%@ Control Language="C#" AutoEventWireup="true" Inherits="Skelta.Bpm.LogicApp.CodeBehind.LogicAppConnectionListRibbonBar" %>
...
<script type="text/javascript">
                    ...
                    "SubItems": [
                        {
                            ...
                            "Text": "<%=GetLangSpecText("ecm_rbn_logicapp_new") %>",
                             "Tooltip": "<%=GetLangSpecText("ecm_rbn_logicapp_new_alt") %>",
                ...
                "Edit":
                    {
                        ...
                        "Text": "<%=GetLangSpecText("ecm_rbn_logicapp_edit")%>",
                        "Tooltip": "<%=GetLangSpecText("ecm_rbn_logicapp_edit_alt")%>",
              ...
              "View":
                  {
                      ...
                      "Text": "<%=GetLangSpecText("ecm_rbn_logicapp_view")%>",
                      "Tooltip": "<%=GetLangSpecText("ecm_rbn_logicapp_view_alt") %>",
                      ...
                      "Action": "javascript:ExecuteActionForSelectedRow('_sys_view_logicappconn')",
                      "OpenMode": "Popup",
                      "SubItems": []
                  }
          },
              ...
              "Delete":
                  {
                      ...
                      "Text": "<%=GetLangSpecText("ecm_rbn_logicapp_delete")%>",
                      "Tooltip": "<%=GetLangSpecText("ecm_rbn_logicapp_delete_alt")%>",
    ...
    function LoadActionBar() {
        ActionBar.init(logicappconnjsonObj, "actionBarDiv");
    }
